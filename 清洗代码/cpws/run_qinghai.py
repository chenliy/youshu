...
from IKEA.cpws.pro.qinghai import qinghai_article
from IKEA.cpws.pro.qinghai import qinghai_list
...
if __name__ == '__main__':
    ...
    for i in range(1):
        for items in mb._execute("select * from judge_doc_qinghai  limit 1".format()):
