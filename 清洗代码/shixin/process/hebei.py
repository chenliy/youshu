...
class Hebei(Base):
    def sxbzx(self):
        ...
        msg = msg if msg else {'被执行人姓名': l_list[0], '案号': l_list[1], '证件号码': l_list[2]}
    ...
    def wjzxssaj(self):
        ...
        self.exposure_desk['reg_date'] = msg.get('立案日期', '1900-01-01')
        ...
        self.exposure_desk['start_date'] = msg.get('限制开始日期')
