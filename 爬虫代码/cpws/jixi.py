...
class Handler(BaseHandler):
    ...
    def on_start(self):
        # 民事文书
        url = 'http://jxzy.hljcourt.gov.cn/public/more.php?LocationID=0402000000'
    ...
    def detail_page(self, response):
        ...
        if "提交日期" not in b[1]:
            ...
            try:
                ...
                court_name = ''
        try:
            time_xq = re.compile(r'(二[一二三四五六七八九十年月日 Ο０〇ＯО0Oo○?]+)', re.S).findall(result)[-1].replace('?','O')  # 如果有问号的话用大写的o代替
        except:
            time_xq = ''
        print(time_xq)
        print(court_name)
