...
class Handler(BaseHandler):
    ...
    def on_start(self):
        for i in range(1, 2):
            url = 'http://sxllzy.chinacourt.org/paper/more/paper_mid/MzAygAMA.shtml#'
            self.crawl(url, headers=self.headers, save={'type1': '刑事文书'}, callback=self.index_page)
        for k in range(1, 2):
            url = 'http://sxllzy.chinacourt.org/paper/more/paper_mid/MzA0MDKAAgA.shtml#'
