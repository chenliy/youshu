#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# Created on 2018-07-12 14:43:50
# Project: cpws_shuangyas
...
class Handler(BaseHandler):
    ...
    def __init__(self):
        self.headers = {
            ...
            'Cookie': 'yunsuo_session_verify=dc516a4c78aa915dcb12deae55c13904',
            'Host': 'syszy.hljcourt.gov.cn',
    ...
    def on_start(self):
        ...
        for i in range(1,367):
            url = 'http://syszy.hljcourt.gov.cn/public/index.php?p={}&module=Paper&controller=Index&action=Index&LocationID=0202000000&enable=1&audit=1&foreign=0&excellent=0&cat1_id=&cat2_id=&cat3_id=&court_id=37&user_court_id=37'.format(i)
    ...
    def detail_page(self, response):
        ...
        if "提交日期" not in b[1]:
            ...
            try:
                ...
                court_name = ''
        try:
            time_xq = re.compile(r'(二[一二三四五六七八九十年月日 Ο０〇ＯО0Oo○〇?]+)', re.S).findall(result)[-1].replace('?','O')  # 如果有问号的话用大写的o代替
        except:
            time_xq = ''
        print(time_xq)
        print(court_name)
