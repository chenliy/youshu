#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# Created on 2018/7/19 16:52
# Project: 
# @Author: ZQJ
# @Email : zihe@yscredit.com

url = 'https://www.mzcourt.gov.cn/courtweb/front/wsxxList?ah=&ay=&fjm=JC0&dsr=&wsmc=&wslx=qbcpws&pagenumber={}&dir=down&cs_token_flag=1&cs_token=7775c3a0dedd489c973fb6289a8f0d8d'
...
for i in range(1,67):
    print(requests.get(url.format(i),headers=headers).text)