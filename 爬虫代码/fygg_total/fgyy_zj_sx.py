...
class Handler(BaseHandler):
    ...
    def __init__(self):
        ...
        self.headers = {
            ...
            'Cookie': ' ASPSESSIONIDAQQRTABB=CMIGOMMDPBFHBFIPOJHMHHFK',
    ...
    def on_start(self):
        ...
        self.crawl(url, headers=self.headers, callback=self.get_page)
    ...
    def index_page(self, response):
        ...
        for each in lists:
            try:
                ...
                self.crawl(url, headers=self.headers, callback=self.detail_page, save={'title': title})
            except:
                continue
