...
class Handler(BaseHandler):
    ...
    def on_start(self):
        for i in range(1, 10):
            url = 'http://hnzy.chinacourt.org/article/index/id/MyirMDDIMDAwMiACAAA/page/{}.shtml'.format(i)
    ...
    def index_page(self, response):
        ...
        urls = []
        times = []
        for each in response.doc('div#list.font14 ul li span.left a[href]').items():
